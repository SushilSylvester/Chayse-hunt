        ...
        var r = t("html, body"),
            ...
            s = {
                ...
                isHash: function(t, n) {
                    ...
                    var o = t.indexOf("#") > -1 ? !0 : !1,
                        r = s.stripHash(t) === s.stripHash(n) ? !0 : !1;
                    return o && r
                },
            ...
            l = function(n) {
                if (null !== n.state) {
                    var o = e.location.href,
                        ...
                        l = event.state !== a.cache[a.href].state;
            ...
            u = function(i, l) {
                            ...
                            g = {
                                loaded: function() {
                                    ...
                                    h && f ? h && S(i.url) : u.one(t, function() {
                                        ...
                                        id: c
                                    }, d[i.url].title, i.url), d[i.url].state = p, e.history.pushState(p, d[i.url].title, i.url)), h && !o && m(i.url)
                                },
                                fetching: function() {
                ...
                return l = t.extend({}, t.fn.smoothState.options, l), null === e.history.state ? (p = l.alterChangeState({
                    id: c
                }, n.title, g), e.history.replaceState(p, n.title, g)) : p = {}, s.storePageIn(d, g, n.documentElement.outerHTML, c, p), s.triggerAllAnimationEndEvent(u, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), O(u), {
                    href: g,
                    cache: d,
                    clear: m,
                    load: w,
