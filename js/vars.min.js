var preload;
var queue = new createjs.LoadQueue(!0);
var scrollcontainer = document.getElementById('ps-scroll-container');
var siteLoading;
var betweenContentLoading = !1;
var volumeSetter = 1;
var soundActive = !1;
var soundPlaying = !1;
var amountOfPlays = 0;
var popStateActive = !1;
var windowWidth;
var windowHeight;
var halfWindowWidth;
...
if (isEdge) {
    document.body.setAttribute('data-edge', !0)
}
var scrollActive;
var smoothScrollActive = (window.innerWidth <= 1024 || isEdge ? !1 : !0);
